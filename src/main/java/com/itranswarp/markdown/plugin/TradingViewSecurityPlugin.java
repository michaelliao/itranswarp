...
public class TradingViewSecurityPlugin implements ParserExtension, HtmlRendererExtension {
	...
	public void extend(HtmlRenderer.Builder rendererBuilder) {
		rendererBuilder
				.nodeRendererFactory(context -> new TradingViewNodeRenderer(context, this.cssStyle, this.options));
	}
...
class TradingViewNodeRenderer implements NodeRenderer {
	...
	public void render(Node node) {
		...
		html.tag("/div");
		html.tag("script");
		html.raw("(function () { var opts = " + this.options + "; opts.container_id = \"" + containerId
				+ "\"; opts.symbol = " + JsonUtil.writeJson(symbol)
