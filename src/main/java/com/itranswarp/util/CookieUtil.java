...
public class CookieUtil {
	...
	static String encodeSessionCookie(AuthProviderType provider, String authId, long expiresAt, String token,
		...
		return Base64.getUrlEncoder().withoutPadding()
				.encodeToString((prefix + ":" + hash).getBytes(StandardCharsets.UTF_8));
	}
	...
	public static void setSessionCookie(HttpServletRequest request, HttpServletResponse response, String cookieStr,
			int maxAgeInSeconds) {
